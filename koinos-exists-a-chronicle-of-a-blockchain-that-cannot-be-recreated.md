...
The bridge was still a team project. Justin [explained in July 2024](https://t.me/koinos_community/285648) that Roamin had built the original bridge base roughly two years earlier and that the Vortex team had resumed it around March 2024. Ederaleng remained the principal bridge developer, while the wider team handled contracts, interface, validators, DevOps, business, and legal formation. Justin estimated that the effort had already consumed more than 240 developer hours by late July; that is a participant's estimate, not a repository-derived time audit. He also made clear that he was helping Vortex get off the ground rather than controlling or operating it alone.
